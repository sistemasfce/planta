------------------------------------------------------------
--[280000230]--  Sistema de evaluaciones - autoevaluacion - form_titulo_cuadro 
------------------------------------------------------------
...
INSERT INTO apex_objeto (proyecto, objeto, anterior, identificador, reflexivo, clase_proyecto, clase, punto_montaje, subclase, subclase_archivo, objeto_categoria_proyecto, objeto_categoria, nombre, titulo, colapsable, descripcion, fuente_datos_proyecto, fuente_datos, solicitud_registrar, solicitud_obj_obs_tipo, solicitud_obj_observacion, parametro_a, parametro_b, parametro_c, parametro_d, parametro_e, parametro_f, usuario, creacion, posicion_botonera) VALUES (
	...
	'Sistema de evaluaciones - autoevaluacion - form_titulo_cuadro', --nombre
	NULL, --titulo
	'0', --colapsable
	NULL, --descripcion
...
INSERT INTO apex_objeto_ut_formulario (objeto_ut_formulario_proyecto, objeto_ut_formulario, tabla, titulo, ev_agregar, ev_agregar_etiq, ev_mod_modificar, ev_mod_modificar_etiq, ev_mod_eliminar, ev_mod_eliminar_etiq, ev_mod_limpiar, ev_mod_limpiar_etiq, ev_mod_clave, clase_proyecto, clase, auto_reset, ancho, ancho_etiqueta, expandir_descripcion, campo_bl, scroll, filas, filas_agregar, filas_agregar_online, filas_agregar_abajo, filas_agregar_texto, filas_borrar_en_linea, filas_undo, filas_ordenar, filas_ordenar_en_linea, columna_orden, filas_numerar, ev_seleccion, alto, analisis_cambios, no_imprimir_efs_sin_estado, resaltar_efs_con_estado, template, template_impresion) VALUES (
	...
	'280000230', --objeto_ut_formulario
	NULL, --tabla
	NULL, --titulo
	NULL, --ev_agregar
	...
	'<p align="JUSTIFY" style="margin-bottom: 0.35cm"><span style="font-size:12px;"><span style="line-height: 10pt;">En esta pantalla Ud. encontrar&aacute; las actividades que le fueron asignadas en el marco del R&eacute;gimen de Carrera Acad&eacute;mica. Para realizar su autoevaluaci&oacute;n deber&aacute; hacer click en la lupa.</span></span></p><p align="JUSTIFY" style="margin-bottom: 0.35cm"><span style="font-size:12px;">Si usted <strong><i>es el responsable</i></strong> de la actividad (de docencia, investigaci&oacute;n, extensi&oacute;n o gesti&oacute;n), deber&aacute; subir el archivo con el informe correspondiente a cada caso, para cada una de las actividades que aparecen listadas en la pantalla.</span></p><p align="JUSTIFY" style="margin-bottom: 0.35cm"><span style="font-size:12px;">Si usted <strong><i>no es el responsable</i></strong> de la actividad deber&aacute; completar el formulario que se despliega a los fines de realizar su autoevaluaci&oacute;n, para cada una de las actividades que aparecen listadas en la pantalla.</span></p><p align="JUSTIFY" style="margin-bottom: 0.35cm"><span style="font-size:12px;">Una vez terminada la autoevaluaci&oacute;n de todas las actividades, se generar&aacute; el INFORME ANUAL DOCENTE.</span></p><p align="JUSTIFY" style="margin-bottom: 0.35cm"><span style="font-size:12px;">Mas informaci&oacute;n sobre el formulario de informe de c&aacute;tedra: <a href="http://web.sistemasfce.com.ar/home/docentes/informe-de-catedra.html" target="_blank">http://web.sistemasfce.com.ar/home/docentes/informe-de-catedra.html</a></span></p><p><span style="font-size:12px;">A medida que vaya subiendo los informes o completando los formularios que se despliegan al lado de cada actividad puede guardar lo realizado hasta el momento haciendo &ldquo;click&rdquo; en el bot&oacute;n GUARDAR. Cuando haya completado toda la carga de la informaci&oacute;n solicitada, para que &eacute;sta quede cargada en el Sistema de Evaluaci&oacute;n Docente, debe hacer &ldquo;click&rdquo; en CONFIRMAR. (Recuerde que una vez confirmada la informaci&oacute;n no podr&aacute; modificarla)</span></p><p>&nbsp;</p><p>[ef id=nada]</p>', --template
...
INSERT INTO apex_objeto_ei_formulario_ef (objeto_ei_formulario_fila, objeto_ei_formulario, objeto_ei_formulario_proyecto, identificador, elemento_formulario, columnas, obligatorio, oculto_relaja_obligatorio, orden, etiqueta, etiqueta_estilo, descripcion, colapsado, desactivado, estilo, total, inicializacion, permitir_html, deshabilitar_rest_func, estado_defecto, solo_lectura, solo_lectura_modificacion, carga_metodo, carga_clase, carga_include, carga_dt, carga_consulta_php, carga_sql, carga_fuente, carga_lista, carga_col_clave, carga_col_desc, carga_maestros, carga_cascada_relaj, cascada_mantiene_estado, carga_permite_no_seteado, carga_no_seteado, carga_no_seteado_ocultar, edit_tamano, edit_maximo, edit_mascara, edit_unidad, edit_rango, edit_filas, edit_columnas, edit_wrap, edit_resaltar, edit_ajustable, edit_confirmar_clave, edit_expreg, popup_item, popup_proyecto, popup_editable, popup_ventana, popup_carga_desc_metodo, popup_carga_desc_clase, popup_carga_desc_include, popup_puede_borrar_estado, fieldset_fin, check_valor_si, check_valor_no, check_desc_si, check_desc_no, check_ml_toggle, fijo_sin_estado, editor_ancho, editor_alto, editor_botonera, selec_cant_minima, selec_cant_maxima, selec_utilidades, selec_tamano, selec_ancho, selec_serializar, selec_cant_columnas, upload_extensiones, punto_montaje, placeholder) VALUES (
	'280000333', --objeto_ei_formulario_fila
	'280000230', --objeto_ei_formulario
