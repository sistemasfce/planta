<?php
class ci_titulos_universitarios extends planta_ci
{
	//-------------------------------------------------------------------------
	function relacion()
	{
	...
	{
		$datos = toba::consulta_php('co_parametros')->get_titulos();
