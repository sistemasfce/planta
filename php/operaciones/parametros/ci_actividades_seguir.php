<?php
class ci_actividades_seguir extends planta_ci
{
    //-------------------------------------------------------------------------
    function relacion()
    {
    ...
    {
        $datos = toba::consulta_php('co_parametros')->get_actividades_a_seguir();
    ...
    function conf__form(planta_ei_formulario $form)
    {
        if ($this->relacion()->esta_cargada()) {
            $datos = $this->tabla('actividades_a_seguir')->get();            
    ...
    {
        $this->tabla('actividades_a_seguir')->set($datos);
