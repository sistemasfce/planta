<?php
class ci_programas_web extends planta_ci
{
		//-------------------------------------------------------------------------
	function relacion()
	{
	...
	{
		$datos = toba::consulta_php('co_parametros')->get_programas_web();
	...
	function conf__form(planta_ei_formulario $form)
	{
		if ($this->relacion()->esta_cargada()) {
			$datos = $this->tabla('actividades_programas')->get();            
	...
	{
		$this->tabla('actividades_programas')->set($datos);
