<?php
class ci_ambitos_evaluaciones extends planta_ci
{
	//-------------------------------------------------------------------------
	function relacion()
	{
	...
	{
		$datos = toba::consulta_php('co_parametros')->get_ambitos_a_evaluar();
	...
	function conf__form(planta_ei_formulario $form)
	{
		if ($this->relacion()->esta_cargada()) {
			$datos = $this->tabla('ambitos_a_evaluar')->get();            
	...
	{
		$this->tabla('ambitos_a_evaluar')->set($datos);
