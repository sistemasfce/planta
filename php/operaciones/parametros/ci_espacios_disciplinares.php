<?php
class ci_espacios_disciplinares extends planta_ci
{
	//-------------------------------------------------------------------------
	function relacion()
	{
	...
	{
		$datos = toba::consulta_php('co_parametros')->get_espacios_disciplinares();
	...
	function conf__form(planta_ei_formulario $form)
	{
		if ($this->relacion()->esta_cargada()) {
			$datos = $this->tabla('espacios_disciplinares')->get();            
	...
	{
		$this->tabla('espacios_disciplinares')->set($datos);
