<?php
class ci_actividades_evaluaciones extends planta_ci
{
	//-------------------------------------------------------------------------
	function relacion()
	{
	...
	{
		$datos = toba::consulta_php('co_parametros')->get_actividades_a_evaluar();
	...
	function conf__form(planta_ei_formulario $form)
	{
		if ($this->relacion()->esta_cargada()) {
			$datos = $this->tabla('actividades_a_evaluar')->get();            
	...
	{
		$this->tabla('actividades_a_evaluar')->set($datos);
