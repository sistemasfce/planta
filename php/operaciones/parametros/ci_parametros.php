<?php
class ci_parametros extends planta_ci
{
	//-------------------------------------------------------------------------
	function relacion()
	{
	...
	{
		$datos = toba::consulta_php('co_parametros')->get_parametros();
	...
	function conf__form(planta_ei_formulario $form)
	{
		if ($this->relacion()->esta_cargada()) {
			$datos = $this->tabla('parametros')->get();            
	...
	{
		$this->tabla('parametros')->set($datos);
