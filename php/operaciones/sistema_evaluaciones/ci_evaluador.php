...
class ci_evaluador extends planta_ci
{
    ...
    {       
        ...
        if ($confirmado['autoeval_confirmado'] != 'S') {
            $this->informar_msg("El docente no completÃ³ su autoevalaciÃ³n","error");
            return;   
        } 
    ...
    function evt__form__modificacion($datos)
    {
        ...
        if ($datos['eval_confirmado'] == 'S' and $datos['eval_calificacion'] == null) {
            $this->informar_msg("No se puede confirmar una evaluaciÃ³n sin cargar la calificaciÃ³n","error");
            return;
        }    
        ...
        if ($datos['eval_confirmado'] == 'N') {
            $this->informar_msg("Los datos se guardaron correctamente, pero la evaluaciÃ³n aÃºn no fue confirmada","notificacion");
        } 
        if ($datos['eval_confirmado'] == 'S') {
