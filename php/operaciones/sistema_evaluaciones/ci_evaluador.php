...
class ci_evaluador extends planta_ci
{
	...
	{  
		...
		if (isset($docente['mail'])) {
			...
			$cuerpo_mail = '<p>'."A través del presente correo le informamos que Ud. fue evaluado en una de sus actividades en el marco del SISTEMA DE EVALUACIÓN DE ACTIVIDADES. ".
