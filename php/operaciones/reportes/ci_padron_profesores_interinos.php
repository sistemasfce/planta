<?php
class ci_padron_profesores_interinos extends planta_ci
{
	protected $s__filtro;
	...
	function conf__cuadro(planta_ei_cuadro $cuadro)
	{
		...
		if ($where != '1=1') {
			...
			$datos = toba::consulta_php('co_designaciones')->get_padron_profesores_interinos($where);
